...
function multiply4(a, b) {
  let teat11=b[0] * a[0] + b[1] * a[4] + b[2] * a[8] + b[3] * a[12];
    let teat12= b[0] * a[1] + b[1] * a[5] + b[2] * a[9] + b[3] * a[13];
    let teat13= b[0] * a[2] + b[1] * a[6] + b[2] * a[10] + b[3] * a[14];
    let teat14=b[0] * a[3] + b[1] * a[7] + b[2] * a[11] + b[3] * a[15];
    let teat15=b[4] * a[0] + b[5] * a[4] + b[6] * a[8] + b[7] * a[12];
    let teat16=b[4] * a[1] + b[5] * a[5] + b[6] * a[9] + b[7] * a[13];
    let teat17=b[4] * a[2] + b[5] * a[6] + b[6] * a[10] + b[7] * a[14];
    let teat18=b[4] * a[3] + b[5] * a[7] + b[6] * a[11] + b[7] * a[15];
    let teat19=b[8] * a[0] + b[9] * a[4] + b[10] * a[8] + b[11] * a[12];
    let teat110=b[8] * a[1] + b[9] * a[5] + b[10] * a[9] + b[11] * a[13];
    let teat111=b[8] * a[2] + b[9] * a[6] + b[10] * a[10] + b[11] * a[14];
    let teat112=b[8] * a[3] + b[9] * a[7] + b[10] * a[11] + b[11] * a[15];
    let teat113=b[12] * a[0] + b[13] * a[4] + b[14] * a[8] + b[15] * a[12];
    let teat114=b[12] * a[1] + b[13] * a[5] + b[14] * a[9] + b[15] * a[13];
